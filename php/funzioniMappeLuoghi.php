...
// LUOGHI E MAPPE
    ...
    function stampaMappaLuoghiRistoro() {
        require 'php/configurazione.php';
        require 'php/connessione.php';
        $sql = "SELECT L.id, L.lettera, L.colore, L.nome, L.latitudine, L.longitudine FROM Luogo AS L WHERE 1 LIMIT 10";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        $stmt->bind_result($id, $lettera, $colore, $nome, $latitudine, $longitudine);
